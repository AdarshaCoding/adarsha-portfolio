export const blogs = [
  {
    ...
    description:
      "In JavaScript, this is special type of function which will take only “one argument” at a time and returns another function expecting next argument, which can internally returns another function or calculate the desired result if all required values available and returns the final result.",
    blogLink:
      "https://medium.com/@adarshapc/function-currying-in-javascript-4d92a46307c6",
  },
  {
    id: 2,
